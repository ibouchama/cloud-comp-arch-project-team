...
CLIENT_AGENT_A="client-agent-a-bhf0"
CLIENT_AGENT_B="client-agent-b-ns12"
CLIENT_MEASURE="client-measure-b8vk"
...
# ─── Setup each VM ─────────────────────────────────────────────────────────────
for INSTANCE in "${CLIENT_AGENT_A}" "${CLIENT_AGENT_B}" "${CLIENT_MEASURE}"; do
  setup_vm "${INSTANCE}"
done
